...
public class AnaSayfa {
	public static void main(String[] args)
	{
	   ...
	   ResimOgretmeni reso=new ResimOgretmeni();
		...
		System.out.println("->Okuldaki Ogretmen sayisi:"+ogr.OgretmenSayisiVer());
		System.out.println("----------------------");
	...
	public static void  OgretmenSirala(MatematikOgretmeni[] m)
	{
	...
	public static void  OgretmenSirala(ResimOgretmeni[] r)
	{
		ResimOgretmeni temp;
